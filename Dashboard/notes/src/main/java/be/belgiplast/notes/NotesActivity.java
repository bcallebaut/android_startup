...
import be.belgiplast.notes.database.NoteHelper;
import be.belgiplast.notes.model.BaseNote;
import be.belgiplast.notes.model.Note;
import be.belgiplast.notes.utils.MyDividerItemDecoration;
import be.belgiplast.notes.utils.RecyclerTouchListener;
...
public class NotesActivity extends AppCompatActivity {
    ...
    private void createNote(String text) {
        ...
        //TODO : set the id (HASH of the text)
        long id = db.insertTask(note);
    ...
    private void showNoteDialog(final boolean shouldUpdate, final Note note, final int position) {
        ...
        View view = layoutInflaterAndroid.inflate(R.layout.note_layout, null);

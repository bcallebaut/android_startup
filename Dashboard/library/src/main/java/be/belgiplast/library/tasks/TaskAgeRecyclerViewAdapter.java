...
class TaskAgeRecyclerViewAdapter extends RecyclerView.Adapter<TaskAgeRecyclerViewAdapter.ViewHolder> {
    ...
    TaskAgeRecyclerViewAdapter(Context context, Action[] data) {
